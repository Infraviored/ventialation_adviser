...
- `entity/` - Base entity class (`VentilationAdvisorEntity`)
...
- All entities inherit: `(PlatformEntity, VentilationAdvisorEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.ventilation_advisor: debug` in `config/configuration.yaml`
