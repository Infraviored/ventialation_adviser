...
- Inherit from `VentilationAdvisorEntity` and platform base class
...
- Entity: `custom_components/ventilation_advisor/[platform]/[entity_name].py`
- Platform: `custom_components/ventilation_advisor/[platform]/__init__.py`
