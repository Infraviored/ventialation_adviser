...
**File:** `custom_components/ventilation_advisor/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: ventilation_advisor
...
Create `custom_components/ventilation_advisor/service_actions/[action_name].py`:

```python
"""[Action name] service action for Ventilation Advisor."""
...
**File:** `custom_components/ventilation_advisor/__init__.py`
...
**File:** `custom_components/ventilation_advisor/const.py`
...
3. Find service action: `ventilation_advisor.[action_name]`
...
- **Service actions directory:** `custom_components/ventilation_advisor/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/ventilation_advisor/services.yaml` (legacy filename)
- **Icons:** `custom_components/ventilation_advisor/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/ventilation_advisor/translations/*.json` under `services` key (legacy)
