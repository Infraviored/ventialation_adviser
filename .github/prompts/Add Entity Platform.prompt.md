...
**Directory:** `custom_components/ventilation_advisor/[platform]/`
...
```python
"""[Platform] platform for Ventilation Advisor."""
...
from .entity import VentilationAdvisorEntity
from .[entity_file] import VentilationAdvisor[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: VentilationAdvisorDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            VentilationAdvisor[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Ventilation Advisor."""
...
class VentilationAdvisor[EntityName](
    VentilationAdvisorEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/ventilation_advisor/manifest.json`:
...
- [ ] Entity class inherits from both `VentilationAdvisorEntity` and platform class
...
- **Class prefix:** `VentilationAdvisor`
- **Base entity:** `VentilationAdvisorEntity` in `entity/base.py`
- **Coordinator:** `VentilationAdvisorDataUpdateCoordinator`
