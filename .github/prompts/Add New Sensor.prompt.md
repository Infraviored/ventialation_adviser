...
- Create new sensor file in `custom_components/ventilation_advisor/sensor/`
- Inherit from `VentilationAdvisorEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Ventilation Advisor."""
...
class VentilationAdvisor[SensorName]Sensor(
...
- Entity: `custom_components/ventilation_advisor/sensor/[sensor_name].py`
- Platform: `custom_components/ventilation_advisor/sensor/__init__.py`
- Translations: `custom_components/ventilation_advisor/translations/*.json`
