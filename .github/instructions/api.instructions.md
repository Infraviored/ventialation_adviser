...
- `VentilationAdvisorApiClientError` (Base)
- `VentilationAdvisorApiClientCommunicationError` (Network, timeout, HTTP errors)
- `VentilationAdvisorApiClientAuthenticationError` (401, 403, invalid credentials)
