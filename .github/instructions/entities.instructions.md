...
- **`entity/`** - Base entity classes (inherit `VentilationAdvisorEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, VentilationAdvisorEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import VentilationAdvisorEntity`
