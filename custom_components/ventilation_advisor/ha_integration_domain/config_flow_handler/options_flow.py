"""
Options flow for ventilation_advisor.
...
from custom_components.ventilation_advisor.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class VentilationAdvisorOptionsFlow(config_entries.OptionsFlow):
    """
...
__all__ = ["VentilationAdvisorOptionsFlow"]
