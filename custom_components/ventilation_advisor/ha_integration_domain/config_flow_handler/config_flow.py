"""
Config flow for ventilation_advisor.
...
from custom_components.ventilation_advisor.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.ventilation_advisor.config_flow_handler.validators import validate_credentials
from custom_components.ventilation_advisor.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME

if TYPE_CHECKING:
    from custom_components.ventilation_advisor.config_flow_handler.options_flow import VentilationAdvisorOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "VentilationAdvisorApiClientAuthenticationError": "auth",
    "VentilationAdvisorApiClientCommunicationError": "connection",
}


class VentilationAdvisorConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for ventilation_advisor.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.ventilation_advisor.config_flow_handler.options_flow import (  # noqa: PLC0415
            VentilationAdvisorOptionsFlow,
        )

        return VentilationAdvisorOptionsFlow()
...
__all__ = ["VentilationAdvisorConfigFlowHandler"]
