...
from custom_components.ventilation_advisor.api import VentilationAdvisorApiClient
...
async def validate_credentials(hass: HomeAssistant, username: str, password: str) -> None:
    ...
    Raises:
        VentilationAdvisorApiClientAuthenticationError: If credentials are invalid.
