"""
Custom integration to integrate ventilation_advisor with Home Assistant.
...
https://github.com/Infraviored/ventiallation-adviser
...
from .data import VentilationAdvisorData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import VentilationAdvisorConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = VentilationAdvisorData(
        client=client,
