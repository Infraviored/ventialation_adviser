"""
API Client for ventilation_advisor.
...
class VentilationAdvisorApiClientError(Exception):
    """Base exception to indicate a general API error."""


class VentilationAdvisorApiClientCommunicationError(
    VentilationAdvisorApiClientError,
):
    """Exception to indicate a communication error with the API."""


class VentilationAdvisorApiClientAuthenticationError(
    VentilationAdvisorApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        VentilationAdvisorApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise VentilationAdvisorApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class VentilationAdvisorApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            VentilationAdvisorApiClientAuthenticationError: If authentication fails.
            VentilationAdvisorApiClientCommunicationError: If communication fails.
            VentilationAdvisorApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise VentilationAdvisorApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise VentilationAdvisorApiClientError(
                msg,
            ) from exception
