"""Number platform for ventilation_advisor."""
...
from .target_humidity import ENTITY_DESCRIPTIONS as HUMIDITY_DESCRIPTIONS, VentilationAdvisorHumidityNumber
...
async def async_setup_entry(
    ...
    async_add_entities(
        VentilationAdvisorHumidityNumber(
