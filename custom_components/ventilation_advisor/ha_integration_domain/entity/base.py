"""
Base entity class for ventilation_advisor.
...
from custom_components.ventilation_advisor.const import ATTRIBUTION
...
class VentilationAdvisorEntity(CoordinatorEntity[VentilationAdvisorDataUpdateCoordinator]):
    """
    Base entity class for ventilation_advisor.
