"""Device info utilities for ventilation_advisor."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Ventilation Advisor",
        manufacturer=manufacturer or "Ventilation Advisor",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('ventilation_advisor', 'entry_id_value')}
    """
