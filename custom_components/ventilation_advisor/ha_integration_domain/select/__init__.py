"""Select platform for ventilation_advisor."""
...
from .fan_speed import ENTITY_DESCRIPTIONS as FAN_SPEED_DESCRIPTIONS, VentilationAdvisorFanSpeedSelect
...
async def async_setup_entry(
    ...
    async_add_entities(
        VentilationAdvisorFanSpeedSelect(
