"""
Core DataUpdateCoordinator implementation for ventilation_advisor.
...
from custom_components.ventilation_advisor.api import (
...
class VentilationAdvisorDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: VentilationAdvisorConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except VentilationAdvisorApiClientAuthenticationError as exception:
