"""
Data update coordinator package for ventilation_advisor.
...
from .base import VentilationAdvisorDataUpdateCoordinator

__all__ = ["VentilationAdvisorDataUpdateCoordinator"]
