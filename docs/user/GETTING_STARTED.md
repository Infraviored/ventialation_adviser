# Getting Started with Ventilation Advisor

This guide will help you install and set up the Ventilation Advisor custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Infraviored/ventiallation-adviser`
6. Set category to "Integration"
7. Click "Add"
8. Find "Ventilation Advisor" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Infraviored/ventiallation-adviser/releases)
2. Extract the `ventilation_advisor` folder from the archive
3. Copy it to `custom_components/ventilation_advisor/` in your Home Assistant configuration directory
...
4. Select entities from "Ventilation Advisor"
...
- Report issues at [GitHub Issues](https://github.com/Infraviored/ventiallation-adviser/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Infraviored/ventiallation-adviser/discussions)
