...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/Infraviored/ventiallation-adviser?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ventiallation-adviser&category=integration)
...
Find all entities in **Settings** → **Devices & Services** → **Ventilation Advisor** → click on the device.
...
### `ventilation_advisor.example_action`
...
```yaml
service: ventilation_advisor.example_action
data:
  # Add your parameters here
```

### `ventilation_advisor.reload_data`
...
```yaml
service: ventilation_advisor.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.ventilation_advisor: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Ventilation Advisor → 3 dots → Download diagnostics)
...
[commits-shield]: https://img.shields.io/github/commit-activity/y/Infraviored/ventiallation-adviser.svg?style=for-the-badge
[commits]: https://github.com/Infraviored/ventiallation-adviser/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/Infraviored/ventiallation-adviser.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40Infraviored-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/Infraviored/ventiallation-adviser.svg?style=for-the-badge
[releases]: https://github.com/Infraviored/ventiallation-adviser/releases
